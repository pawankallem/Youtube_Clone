...
async function youtube() {
  try {
    let x = await fetch(`https:youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=in&maxResults=10&key=AIzaSyAeiEv8dmO2Nv2gDPe-uUswEKcGmW54Mt4`);
